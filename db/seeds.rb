...
trip = Trip.create!(uid: '106758666395730546327', name: 'Test_Trip', departure_date: Time.current + 30.seconds,
...
trip = Trip.create!(uid: '106758666395730546327', name: 'Test_Trip_2', departure_date: Time.current + 30.seconds,
...
trip = Trip.create!(uid: '106758666395730546327', name: 'Test_Trip_3', departure_date: Time.current + 30.seconds,
