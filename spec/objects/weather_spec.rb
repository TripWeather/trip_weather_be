...
RSpec.describe Weather do
  weather_hash = {:name=>"This Afternoon", :temperature=>74, :shortForecast=>"Partly Sunny", :detailedForecast=>"Partly sunny, with a high near 74. South wind 20 to 25 mph, with gusts as high as 40 mph."}
